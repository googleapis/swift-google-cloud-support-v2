...
public struct CaseClassification: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CaseClassification`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CaseClassification().with { $0.id = ... }
  /// ```
