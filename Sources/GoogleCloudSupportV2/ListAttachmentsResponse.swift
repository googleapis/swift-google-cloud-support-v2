  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListAttachmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAttachmentsResponse().with { $0.attachments = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.support.v2.ListAttachmentsResponse"
  }
