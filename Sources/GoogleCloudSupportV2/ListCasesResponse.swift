...
public struct ListCasesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListCasesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCasesResponse().with { $0.cases = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.support.v2.ListCasesResponse"
  }
