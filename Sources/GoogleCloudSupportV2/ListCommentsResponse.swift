...
public struct ListCommentsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListCommentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCommentsResponse().with { $0.comments = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Comment].self, forKey: .comments) {
      self.comments = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.support.v2.ListCommentsResponse"
  }
