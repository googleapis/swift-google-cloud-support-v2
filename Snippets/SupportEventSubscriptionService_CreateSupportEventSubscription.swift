...
func sample(client: SupportEventSubscriptionServiceClient, organizationId: String) async throws {
  let response = try await client.createSupportEventSubscription(
